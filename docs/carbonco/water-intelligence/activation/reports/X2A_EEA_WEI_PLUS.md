...
**Verdict :** `manual_artifact_required`  
**Release :** `eea_v_3035_250_k_wei-subunit-level_p_2023_v01_r00`  
**Exécuté le :** 2026-07-26T11:23:29.696622+00:00  
...
|---|---|---|---|---|---|---|
| 1 | `https://sdi.eea.europa.eu/catalogue/srv/api/records/b16bd284-f2ec-4164-90b7-674c1de399ba` | 200 | application/json | 54903 | `4a9ab1eac95600d4…` | 0.563 s |
...
```json
{
  ...
  "errors": [],
  "executed_at": "2026-07-26T11:23:29.696622+00:00",
  "geographies": [],
  "limits": {
    "max_bytes": 5000000,
    "timeout_seconds": 25.0
