...
**Wave C — Produit public (MACRO-PROMPT C).**
...
- Wave C (P10 read model + P11 carte + P12 contenus) : **en cours**.
- Wave D : **à ne pas démarrer** avant revue humaine et fusion de Wave C.
