...
**Release :** `hubeau-naiades-analyse-pc-2026-07-26-x2a`  
**Exécuté le :** 2026-07-26T11:23:18.544040+00:00  
...
|---|---|---|---|---|---|---|
| 1 | `https://hubeau.eaufrance.fr/api/v2/qualite_rivieres/analyse_pc` | 206 | application/json | 293799 | `cc88d7071ad05926…` | 0.262 s |
...
```json
{
  ...
  "dry_run": true,
  "duration_seconds": 0.286,
  "errors": [],
  "executed_at": "2026-07-26T11:23:18.544040+00:00",
  "geographies": [
    "06000579",
    "06000580",
    "06178006",
  ...
  "records_rejected": 0,
  "rejection_causes": [],
  "release_key": "hubeau-naiades-analyse-pc-2026-07-26-x2a",
  "source_code": "HUBEAU_QUALITE_SURFACE",
  "transfers": [
    {
      "bytes_received": 293799,
      "content_type": "application/json",
      "elapsed_seconds": 0.262,
      "error": null,
      "params": [
        [
          "code_departement",
