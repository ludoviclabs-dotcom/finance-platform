"""Verify NEURAL Insurance Supply Chain workbooks."""
...
FOUNDATION_SHEETS = [
    ...
    "3_GATE_REGISTRY",
    "4_PROVIDER_TYPOLOGY",
    "5_REPAIR_NETWORK_RULES",
    "6_EXPERTISE_RULES",
    "7_FRAUD_SIGNALS",
    "8_SAPIN2_THIRD_PARTY",
    "9_REG_WATCH_SEEDS",
    "10_TESTSET_INDEX",
    "11_CHANGELOG",
]
...
def verify() -> int:
    errors: list[str] = []
    print("=" * 74)
    print("  NEURAL / INSURANCE / SUPPLY CHAIN - workbook verification")
    print("=" * 74)
    ...
    print()
    print("  Isolation")
    print("    verifier does not write or inspect luxe-comms, aero-comms or public site outputs")
