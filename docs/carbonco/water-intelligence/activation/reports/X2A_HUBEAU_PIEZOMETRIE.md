...
**Release :** `hubeau-piezometrie-chroniques-2026-07-26-x2a`  
**Exécuté le :** 2026-07-26T11:23:09.242519+00:00  
...
|---|---|---|---|---|---|---|
| 1 | `https://hubeau.eaufrance.fr/api/v1/niveaux_nappes/chroniques` | 200 | application/json | 52139 | `52bc5f94759d7c96…` | 1.251 s |
...
```json
{
  ...
  "errors": [],
  "executed_at": "2026-07-26T11:23:09.242519+00:00",
  "geographies": [
    "09892X0679/EXH70"
  ],
  "limits": {
  ...
  "records_rejected": 0,
  "rejection_causes": [],
  "release_key": "hubeau-piezometrie-chroniques-2026-07-26-x2a",
  "source_code": "HUBEAU_ADES",
  "transfers": [
    {
      "bytes_received": 52139,
      "content_type": "application/json",
      "elapsed_seconds": 1.251,
      "error": null,
      "params": [
        [
          "code_bss",
