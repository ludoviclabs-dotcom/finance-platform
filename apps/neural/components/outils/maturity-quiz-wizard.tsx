...
export function MaturityQuizWizard() {
  ...
  if (showResult && result) {
    const cls = COLOR_CLASSES[result.tier.color] || COLOR_CLASSES["violet"];
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-[24px] border border-white/10 bg-white/[0.04] p-6 md:p-8">
          ...
          <p className="mt-1 text-sm leading-relaxed text-white/55">
            Vos points forts et zones d&apos;amélioration sur les 5 axes de la maturité IA.
          </p>
        ...
        <div className="rounded-[24px] border border-violet-400/25 bg-violet-400/[0.06] p-6 md:p-8">
          ...
          <p className="mt-1 text-sm leading-relaxed text-white/65">
            Quatre priorités à entamer dans les 90 prochains jours pour passer au niveau supérieur.
          </p>
          ...
          <div className="flex flex-col items-start gap-4 md:flex-row md:items-center md:justify-between">
            <div className="max-w-xl">
              <div className="flex items-center gap-2 text-emerald-300">
                ...
                <span className="text-[11px] uppercase tracking-[0.18em]">Audit personnalisé</span>
              </div>
              <h3 className="mt-2 font-display text-xl font-bold tracking-tight text-white">
                Approfondir l&apos;audit avec NEURAL
              </h3>
              <p className="mt-2 text-sm leading-relaxed text-white/65">
                30 minutes pour cadrer le plan de bataille opérationnel sur votre contexte. Sortie
                : feuille de route 30/60/90 jours signée.
              </p>
            </div>
            <Link
