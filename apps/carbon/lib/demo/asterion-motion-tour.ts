 ...
 * Le parcours reste entièrement autonome et fictif. Le mode director enchaîne
 * automatiquement (~2 min) ; aucune étape ne renvoie vers une page métier
 * réelle qui pourrait exposer un autre tenant.
 */
...
export interface TourStep {
  ...
  title: string;
  narration: string;
  /** Destination publique et explicitement sûre, si l'étape en propose une. */
  exploreHref?: string;
...
export const ASTERION_TOUR: TourStep[] = [
  {
    ...
    metric: ASTERION_METRICS.motors, durationMs: 11000,
  },
  {
    ...
    metric: ASTERION_METRICS.purchases, durationMs: 12000,
  },
  {
    ...
    metric: ASTERION_METRICS.magnetsShare, durationMs: 14000,
  },
  {
    ...
    metric: ASTERION_METRICS.dependency, durationMs: 13000,
  },
  {
    ...
    metric: ASTERION_METRICS.scope2Mb, durationMs: 13000,
  },
  {
    ...
    metric: ASTERION_METRICS.water, durationMs: 12000,
  },
  {
    ...
    metric: ASTERION_METRICS.exposure, durationMs: 13000,
  },
  {
    ...
    durationMs: 18000, isAiStep: true,
  },
  {
