...
export const metadata: Metadata = {
  ...
  description:
    "AG-002 LuxePressAgent : redige communiqués dans le registre du luxe. Adapte presse lifestyle (Vogue, HB, Numero) vs. business (FT, BoF, WWD) via media matrix, gere embargos et press pickup. Démo live angle generator.",
};
      ...
      <div className="space-y-12">
        ...
        <div>
          ...
          <p className="mt-3 max-w-3xl text-white/60">
            Collez votre brief, choisissez Vogue / FT / BoF / T Magazine… L&apos;agent généré l&apos;angle,
        ...
        <div>
          ...
          <p className="mt-3 max-w-3xl text-white/60">
            Chaque outlet a son angle éditorial, sa longueur cible, son protocole embargo, son statut
