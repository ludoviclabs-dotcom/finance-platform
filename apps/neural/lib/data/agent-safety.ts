...
export const agentSafetyProfiles: AgentSafetyProfile[] = [
  ...
  {
    agentId: "AG-F104",
    agentName: "HedgeAccountingAgent",
    route: "/agents/hedge-accounting",
    owner: "Tresorerie + Comptabilite groupe",
    riskLevel: "high",
    riskLabel: "Comptabilite de couverture IFRS 9",
    aiActClass: "Risque limite a haut (impact direct sur P&L)",
    dataScope: "Derives FX/IR du tenant, expositions sous-jacentes, tests d'efficacite, documentation hedge.",
    allowedTools: ["Hedge documentation registry", "Effectiveness tester", "Reclassification simulator"],
    forbiddenActions: [
      "Comptabiliser une operation sans documentation hedge",
      "Declarer une efficacite hors corridor 80-125% sans review",
      "Modifier une relation de couverture historisee",
    ],
    hitlRequiredFor: [
      "Designation initiale d'une relation de couverture",
      "Test d'efficacite hors corridor",
      "De-designation et reclassification OCI -> P&L",
    ],
    deterministicGates: [
      "GATE-HEDGE-DOCUMENTATION",
      "GATE-HEDGE-EFFECTIVENESS",
      "GATE-HEDGE-CORRIDOR-80-125",
      "GATE-HEDGE-OCI-WATERFALL",
    ],
    fallbackBehavior: "Calcul manuel sur template Excel signe si moteur indisponible, pas d'auto-comptabilisation.",
    knownLimits: [
      "Couverture limitee aux derives plain-vanilla (forwards FX, swaps IRS)",
      "Pas de test d'efficacite retrospectif sur derives exotiques",
      "Ne remplace pas la revue commissaire aux comptes",
    ],
    lastTestset: "12 relations de couverture x 3 tests d'efficacite annuels.",
  },
  {
    agentId: "AG-F105",
    agentName: "Pilier2GloBEAgent",
    route: "/agents/pilier2-globe",
    owner: "Direction fiscale groupe + DAF",
    riskLevel: "high",
    riskLabel: "Fiscalite internationale Pilier 2 OCDE",
    aiActClass: "Risque limite a haut (declaration fiscale)",
    dataScope: "Donnees CbCR du tenant, ETR par juridiction, ajustements GloBE, top-up tax calculations.",
    allowedTools: ["GloBE rules engine", "ETR calculator", "Safe harbor evaluator", "Top-up tax simulator"],
    forbiddenActions: [
      "Soumettre une declaration GloBE Information Return sans validation fiscaliste",
      "Inventer une juridiction ou un ajustement",
      "Modifier un taux statutaire historise",
    ],
    hitlRequiredFor: [
      "Validation du calcul ETR par juridiction",
      "Application d'un safe harbor",
      "Top-up tax > 1% du resultat consolide",
    ],
    deterministicGates: [
      "GATE-GLOBE-PERIMETER",
      "GATE-GLOBE-ETR-15PCT",
      "GATE-GLOBE-SAFE-HARBOR",
      "GATE-GLOBE-GIR-FORMAT",
    ],
    fallbackBehavior: "Calcul ETR par juridiction sur template OCDE deterministe, sans LLM.",
    knownLimits: [
      "Couverture des juridictions UE + UK + CH + US uniquement (v1)",
      "Pas de simulation des Qualified Domestic Minimum Top-up Tax (QDMTT)",
      "Ne remplace pas l'avis du fiscaliste pour les structures complexes",
    ],
    lastTestset: "8 juridictions x 3 annees CbCR.",
  },
  {
    agentId: "AG-F106",
    agentName: "GoodwillIFRS3Agent",
    route: "/agents/goodwill-ifrs3",
    owner: "Direction M&A + Consolidation",
    riskLevel: "high",
    riskLabel: "Goodwill et tests de depreciation IFRS 3 / IAS 36",
    aiActClass: "Risque limite a haut (impact comptes consolides)",
    dataScope: "PPA (purchase price allocation) historises, UGT, flux de tresorerie previsionnels, taux d'actualisation.",
    allowedTools: ["PPA registry", "Impairment tester", "WACC calculator", "Sensitivity analyzer"],
    forbiddenActions: [
      "Comptabiliser une depreciation sans test annuel",
      "Modifier un PPA historique apres 12 mois",
      "Lisser un goodwill negatif (badwill) sans passage en P&L",
    ],
    hitlRequiredFor: [
      "Conclusion d'un test d'impairment",
      "Validation des hypotheses de flux previsionnels",
      "Allocation initiale du PPA sur une acquisition",
    ],
    deterministicGates: [
      "GATE-IFRS3-PPA-12M",
      "GATE-IAS36-IMPAIRMENT-ANNUAL",
      "GATE-IAS36-RECOVERABLE-AMOUNT",
      "GATE-IFRS3-BADWILL-PL",
    ],
    fallbackBehavior: "Test d'impairment manuel sur template DCF si moteur indisponible.",
    knownLimits: [
      "Ne genere pas le PPA initial (input du tenant)",
      "Sensitivity analysis limitee a 3 variables (WACC, croissance terminale, marge)",
      "Ne remplace pas la fairness opinion d'un expert independant",
    ],
    lastTestset: "6 UGT x 3 scenarios (base, stress -10%, stress -20%).",
  },
  {
    agentId: "AG-A403",
    agentName: "IFRS17EngineAgent",
    route: "/agents/ifrs17-engine",
    owner: "Direction actuariat + Direction comptable assurance",
    riskLevel: "high",
    riskLabel: "Moteur IFRS 17 (CSM, BBA, PAA, VFA)",
    aiActClass: "Risque limite a haut (impact P&L et solvabilite)",
    dataScope: "Portefeuilles assurance du tenant, contracts groups, cash flows projetes, taux d'actualisation, risk adjustment.",
    allowedTools: ["IFRS 17 calculation engine", "Cohort builder", "Discount rate library", "CSM amortiser"],
    forbiddenActions: [
      "Re-classifier un contract group historise",
      "Modifier un taux d'actualisation post-cloture",
      "Cloturer un exercice avec CSM negative non onerous",
    ],
    hitlRequiredFor: [
      "Selection de la methode (BBA, PAA, VFA) par portefeuille",
      "Calibration du risk adjustment",
      "Reconnaissance d'un contract onereux",
    ],
    deterministicGates: [
      "GATE-IFRS17-COHORT-ANNUAL",
      "GATE-IFRS17-CSM-NON-NEGATIVE",
      "GATE-IFRS17-ONEROUS-DETECTION",
      "GATE-IFRS17-DISCOUNT-CURVE",
    ],
    fallbackBehavior: "Calcul deterministe via template EIOPA si moteur indisponible, sans LLM.",
    knownLimits: [
      "Couverture des contracts non-vie + vie standard (pas de produits structures)",
      "Pas de simulation Solvabilite 2 capital",
      "Ne remplace pas la certification actuarielle",
    ],
    lastTestset: "5 portefeuilles x 4 trimestres EIOPA stress test.",
  },
  {
    agentId: "AG-A404",
    agentName: "DisclosureIFRS17Agent",
    route: "/agents/disclosure-ifrs17",
    owner: "Direction comptable assurance + Communication financiere",
    riskLevel: "high",
    riskLabel: "Disclosures IFRS 17 (annexes consolidees)",
    aiActClass: "Risque limite a haut (information financiere publique)",
    dataScope: "Resultats IFRS 17 du tenant, mouvements CSM, reconciliations, sensitivity tables.",
    allowedTools: ["Disclosure template engine", "Movement reconciler", "Sensitivity table builder", "XBRL tagger"],
    forbiddenActions: [
      "Modifier un chiffre historise apres signature CAC",
      "Generer une note d'annexe sans rapprochement avec le moteur IFRS 17",
      "Publier un communique de presse sans HITL",
    ],
    hitlRequiredFor: [
      "Validation de chaque note d'annexe avant publication",
      "Toute mention d'impact sur ratios prudentiels",
      "Mise a jour de la sensitivity table",
    ],
    deterministicGates: [
      "GATE-DISCLOSURE-RECONCILIATION",
      "GATE-DISCLOSURE-MOVEMENT-CSM",
      "GATE-DISCLOSURE-XBRL-TAGS",
      "GATE-DISCLOSURE-IAS-PRESENTATION",
    ],
    fallbackBehavior: "Template Word/Excel deterministe pre-rempli, sans LLM, validation manuelle.",
    knownLimits: [
      "Pas de generation du rapport ESEF complet (XBRL partiel)",
      "Ne remplace pas la revue par le college des CAC",
      "Sensitivity tables limitees aux drivers IFRS 17 (pas FX ni equity)",
    ],
    lastTestset: "3 jeux de comptes consolides x 8 notes d'annexe.",
  },
  {
    agentId: "AG-SC304",
    agentName: "LuxeTraceabilityAgent",
    route: "/agents/luxe-traceability",
    owner: "Direction supply chain + Conformite RSE",
    riskLevel: "high",
    riskLabel: "Tracabilite matieres premieres (CSDDD, LkSG, EUDR)",
    aiActClass: "Risque limite a haut (devoir de vigilance fournisseurs)",
    dataScope: "Tier-1 a Tier-N fournisseurs du tenant, certificats origine, audits sociaux, mines / fermes / tanneries.",
    allowedTools: ["Supplier registry", "Certificate validator", "Geo-mapper", "Audit history reader"],
    forbiddenActions: [
      "Certifier une origine sans evidence chain complete",
      "Masquer un audit social negatif",
      "Supprimer un fournisseur de l'historique",
    ],
    hitlRequiredFor: [
      "Validation d'une declaration CSDDD annuelle",
      "Suspension d'un fournisseur",
      "Reconnaissance d'un certificat tiers (RJC, LWG, Better Cotton)",
    ],
    deterministicGates: [
      "GATE-TRACEABILITY-CHAIN-COMPLETE",
      "GATE-CSDDD-RISK-MAPPING",
      "GATE-EUDR-DEFORESTATION-FREE",
      "GATE-CERTIFICATE-NOT-EXPIRED",
    ],
    fallbackBehavior: "Mapping statique Tier-1 uniquement si moteur indisponible, escalade conformite.",
    knownLimits: [
      "Granularite limitee a Tier-3 dans la v1 (Tier-N en backlog)",
      "Pas de fetch live registres miniers (data semi-statique)",
      "Ne remplace pas l'audit terrain par un tiers independant",
    ],
    lastTestset: "8 chaines (cuir, soie, or, diamant, coton, cachemire, parfum, vins) x 3 niveaux.",
  },
  {
    agentId: "AG-SC305",
    agentName: "AntiCounterfeitSCAgent",
    route: "/agents/anti-counterfeit-sc",
    owner: "Direction brand protection + Supply chain",
    riskLevel: "high",
    riskLabel: "Lutte contre la contrefacon (DAC7, brand IP)",
    aiActClass: "Risque limite a haut (impact brand + actions legales)",
    dataScope: "Catalogue references officielles, signaux marketplaces, saisies douanieres, certificats authenticite.",
    allowedTools: ["Reference catalog", "Marketplace signal aggregator", "Customs seizure database", "DPP (Digital Product Passport) verifier"],
    forbiddenActions: [
      "Notifier une takedown directement aupres d'une marketplace",
      "Engager une action legale contre un vendeur",
      "Modifier le catalogue de references officielles",
    ],
    hitlRequiredFor: [
      "Validation d'un signalement avant takedown",
      "Escalade aupres des douanes ou de la gendarmerie",
      "Reconnaissance d'un faux positif (vendeur autorise non liste)",
    ],
    deterministicGates: [
      "GATE-REFERENCE-OFFICIAL",
      "GATE-DPP-SIGNATURE-VALID",
      "GATE-MARKETPLACE-WHITELIST",
      "GATE-CUSTOMS-NOT-DUPLICATE",
    ],
    fallbackBehavior: "Liste statique des signaux prioritaires si moteur indisponible, traitement manuel brand team.",
    knownLimits: [
      "Couverture marketplaces limitee a 12 plateformes (v1)",
      "Pas d'OCR sur images (signaux textuels uniquement)",
      "Ne remplace pas l'expertise brand protection juridique",
    ],
    lastTestset: "6 maisons x 4 categories produits x 3 marketplaces.",
  },
  {
    agentId: "AG-RH204",
    agentName: "ArtisanScoutAgent",
    route: "/agents/artisan-scout",
    owner: "Direction RH + Maitres artisans",
    riskLevel: "high",
    riskLabel: "Sourcing artisans rares (recrutement RGPD)",
    aiActClass: "Risque haut (AI Act Annexe III - emploi et recrutement)",
    dataScope: "CV candidats consentis, portfolios publics, base ecoles d'art (avec consentement), historique recrutements anonymise.",
    allowedTools: ["Portfolio analyzer", "Skill matcher", "Geo router", "Consent registry"],
    forbiddenActions: [
      "Scraper des profils sociaux sans consentement",
      "Stocker des donnees biometriques (photos analysees)",
      "Discriminer sur age, genre, origine, handicap (controles deterministes)",
      "Notifier un candidat directement",
    ],
    hitlRequiredFor: [
      "Toute presentation finale d'un candidat",
      "Reject automatique (interdit, bascule en review)",
      "Mise a jour des criteres de matching",
      "Suppression d'un candidat sur demande RGPD",
    ],
    deterministicGates: [
      "GATE-RGPD-CONSENT",
      "GATE-NON-DISCRIMINATION",
      "GATE-AI-ACT-ANNEXE-III",
      "GATE-RETENTION-MAX",
      "GATE-PORTFOLIO-PUBLIC",
    ],
    fallbackBehavior: "Matching deterministe sur skills uniquement (pas de score LLM) si AI Gateway indisponible.",
    knownLimits: [
      "Couverture geographique FR + IT + CH uniquement (v1)",
      "Pas d'evaluation du geste artisan a distance (necessaire test physique)",
      "Ne remplace pas l'entretien par un maitre artisan",
      "Annexe III AI Act : evaluations conformite renforcees, registre EU obligatoire avant production",
    ],
    lastTestset: "12 metiers d'art x 4 candidats fictifs (fairness audit OWASP LLM09).",
  },
];
