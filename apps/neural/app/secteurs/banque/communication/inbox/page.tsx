...
export const metadata: Metadata = {
  ...
  description:
    "Runs persistés dans AgentRun, filtrables par agent et par statut. WAITING_APPROVAL en priorité. Mode dégradé si DATABASE_URL absent.",
};
      ...
      <section className="border-b border-white/5 px-6 py-14 md:px-12">
        <div className="mx-auto max-w-[1280px]">
          ...
          <p className="mt-4 max-w-3xl text-white/70">
            ...
            . PASS vers DONE, PASS_WITH_REVIEW vers WAITING_APPROVAL, BLOCK vers
